...
public class OrderDetail_Packed extends AppCompatActivity implements View.OnClickListener, UrlAsync.AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_detail__packed);
...
//                BtnDone.setLayoutParams(param);
                ...
                dtb = new PackedDetailAdapter(OrderDetailList, OrderDetail_Packed.this);
    ...
    private void setData() {
        try {
            ...
            Intent i = new Intent(OrderDetail_Packed.this, Login.class);
    ...
    private void LoadUrl() {
        ...
        new UrlAsync(OrderDetail_Packed.this, Url.toString(), OrderDetail_Packed.this, "OrderDetail", true, Token).execute();
    }//    new UrlAsync(OrderDetail_Packed.this, Url.toString(), OrderDetail_Packed.this, "OrderDetail", true, Token).execute("");
...
//              dt.ProductVariant  =  String.valueOf(jsonObject.getString("category"));
            ...
            dtb = new PackedDetailAdapter(OrderDetailList, this);
            DetailList.setAdapter(dtb);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ImgBack:
                startActivity(new Intent(OrderDetail_Packed.this, MainActivity.class));
                finish();
                break;
            case R.id.ImgEdit:
                BagcountPopup(1);
    ...
    public void BagcountPopup(final int value) {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                Toast.makeText(OrderDetail_Packed.this, RadioBtn.getText(), Toast.LENGTH_SHORT).show();
            }
        });
...
//                productModel.setBagcount(Bag);
                if (Bag.equals("0")) {
                    Toast.makeText(OrderDetail_Packed.this, "invalid Bagcount", Toast.LENGTH_SHORT).show();
                } else {
...
//                        Bag = "0" + Bag;
                ...
                dialog.setCancelable(false);
                if (value == 0) {
                    new MyAsyncTaskPacked().execute();
                    Toast.makeText(OrderDetail_Packed.this, "Package ready for Delivery", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(OrderDetail_Packed.this, MainActivity.class));
                }
            }
        });
    ...
    public void Load() {
        ...
        new UrlAsync(OrderDetail_Packed.this, Url.toString(), OrderDetail_Packed.this, "OrderDetail", true, employeeModel.getToken()).execute("");
    }


    public class PackedDetailAdapter extends RecyclerView.Adapter<PackedDetailAdapter.MyViewHolder> {
        ArrayList<ProductModel> OrderDetailList;
        Context context;

        public PackedDetailAdapter(ArrayList<ProductModel> OrderDetailList, Context context) {
            this.OrderDetailList = OrderDetailList;
            this.context = context;
        }

        @Override
        public PackedDetailAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.orderdetail_row, parent, false);
            return new PackedDetailAdapter.MyViewHolder(view);
        }


        @Override
        public void onBindViewHolder(final PackedDetailAdapter.MyViewHolder holder, final int position) {
            ...
            for (int i = 0; i < OrderDetailList.size(); i++) {
                if (OrderDetailList.get(i).getItemStatus().equalsIgnoreCase("NotAvailable") &&
                        OrderDetailList.get(i).getProductId().equals(g.getProductId())) {
...
//                    holder.Quantity.setTextColor(getResources().getColor(R.color.colorWhite));
                ...
                if (EditOrder.equalsIgnoreCase("EditOrder") &&
                        OrderDetailList.get(i).getProductId().equals(g.getProductId()) &&
                        OrderDetailList.get(i).getItemStatus().equalsIgnoreCase("NotAvailable")) {
...
//                Quantity = (TextView) itemView.findViewById(R.id.Quantity);
    ...
    private void button() {
        int Packed = 0;
        for (int i = 0; i < OrderDetailList.size(); i++) {
            if (OrderDetailList.get(i).getItemStatus().equalsIgnoreCase("Available")) {
                Packed++;
            }
            if (Packed == OrderDetailList.size()) {
                TxtEditOrder.setVisibility(View.GONE);
            }
        }
    }
...
//            BtnBarcode.setBackgroundColor(getResources().getColor(R.color.colorGrey));
    ...
    private class MyAsyncTaskPacked extends AsyncTask<String, Integer, Double> {
